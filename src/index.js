...
const skin = {
        ...
        videos: [
            {
                ...
                videoId: "",
                description: "Private 5G presents enterprise clients with a cost-effective, adaptable, and simpler substitute for traditional wired networks. As a Cisco Global Gold Integrator partner, Logicalis stands as the evident selection to assist in the implementation, administration, and upkeep of your private 5G infrastructure.",
            },
        ],
    ...
    projects: {
        projects: [
            {
                title: "GitHub",
                description: "Visit my GitHub page to view my most recent repositories.",
    ...
    contact: {
        title: "Let's Connect.",
        description: "I am enthusiastic about the prospect of connecting with you and exploring how my skills and passions align with the vision of your team.",
