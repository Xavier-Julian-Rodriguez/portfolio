...
2. **Alternative Stylings**: Some basic changes to stylings can be changed within the index.ts. However for more specific alterations such as margins, or paddings, look for the component stylings in src > stylings.
